...
public class BadgeView extends ImageView {
    ...
    public BadgeView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            badgeCol = a.getInteger(R.styleable.BadgeView_badgeColor, 0);
    ...
    /*Setters*/
    public void setBadgeCollor(int newColor) {
